...
export default class ProductForm {
  ...
  getFormData() {
    ...
    this.addImagesToFormData(result);
    return result;
  }

  addImagesToFormData(result) {
    const images = [];
    const imagesList = this.subElements.productForm.querySelectorAll('li.products-edit__imagelist-item');
